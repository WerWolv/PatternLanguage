...
project = 'Pattern Language Documentation'
author = 'WerWolv'
...
#
html_theme = 'furo'
html_title = "Pattern Language Documentation"
...
class PatternLanguageLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            (r'(?<![a-zA-Z0-9_])(using|struct|union|enum|bitfield|be|le|fn|return|in|out|continue|break)(?![a-zA-Z0-9_])', token.Keyword.Reserved),
