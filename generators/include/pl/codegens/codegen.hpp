...
namespace pl::gen::code {
    ...
    class Codegen {
    public:
        explicit Codegen(std::string name) : m_name(std::move(name)) { }
        ...
        [[nodiscard]] virtual std::string generate(const PatternLanguage &runtime, const std::vector<std::shared_ptr<pl::core::ast::ASTNode>> &ast) = 0;
